class VueDonnees {
	...
	creerDivs(types) {
		...
		if(types.length == 2) {
			...
			textAccueil += "<div class='row'><div class='col l6 m12'><div class='card marge-top blue-grey darken-3'><div class='card-image waves-effect waves-block amber darken-4 marge bord-arrondi'><div class='ct-chart2 ct-perfect-fourth ct-series-a'></div></div><div class='card-content'><span class='card-title activator white-text'>" + types[3].type + "</span><p><a href='#' class='blue-text text-lighten-4'>Consulter</a></p></div></div></div>";
			textAccueil += "<div class='col l6 m12'><div class='card marge-top blue-grey darken-3'><div class='card-image waves-effect waves-block deep-orange accent-3 marge bord-arrondi'><div class='ct-chart3 ct-perfect-fourth ct-series-a'></div></div><div class='card-content'><span class='card-title activator white-text'>" + types[4].type + "</span><p><a href='#' class='blue-text text-lighten-4'>Consulter</a></p></div></div></div></div>";
		}
